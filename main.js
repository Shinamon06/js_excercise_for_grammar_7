...
console.log('追加前 : ', array3);
array3.push('コメント4');
console.log('追加後 : ', array3);
...
console.log=('取り除く前 : ', array4);
const poppedValue = array4.pop();
console.log=('取り除いた後 : ', array4);
console.log=('poppedValueの値 : ', poppedValue);
...
console.log=('追加する前 : ', array5);
array5.unshift('最優先タスク');
console.log=('追加後 : ', array5);
...
console.log=('取り除く前 : ', array6);
const shiftedValue = ayyay6.shift();
console.log=('取り除いた後 : ', array6);
console.log=('shiftedValueの値 : ', shiftedValue);
